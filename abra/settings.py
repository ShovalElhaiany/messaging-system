...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'messaging-system.up.railway.app']

CSRF_TRUSTED_ORIGINS = ['https://messaging-system.up.railway.app']
...
INSTALLED_APPS = [
    ...
    "messaging_system.apps.MessagingSystemConfig",  # My messaging system app
